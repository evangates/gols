...
public class PaintableTexture {
  ...
  public void setPixelR(int x, int y, Color color) {
		int i = (x + y * width) * 4;
		data[i] = (byte) color.getRed(); // r
  }
  
	public void setPixelG(int x, int y, Color color) {
		int i = (x + y * width) * 4;
		data[i + 1] = (byte) color.getGreen(); // g
	}
  
	public void setPixelB(int x, int y, Color color) {
		int i = (x + y * width) * 4;
		data[i + 2] = (byte) color.getBlue(); // b
	}
  
	public void setPixelA(int x, int y, Color color) {
		int i = (x + y * width) * 4;
